...
HTML 原型预览仓库。发给同事请用下面的 **Pages 链接**（能直接打开页面），不要用本仓库的 Code 页地址。

## 分享用链接（复制即可）

**总导航页（推荐只发这一个）：**

https://sara-ji.github.io/Prototype/
...
- 预览地址形如：`https://sara-ji.github.io/Prototype/...`
- 仓库地址 `https://github.com/sara-ji/Prototype` 只能看代码，不能当预览链接分享
